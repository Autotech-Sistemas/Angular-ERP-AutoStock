...
// ─── Availability badge ──────────────────────────────────────────────────────
export function availabilityClass(a: string | null | undefined): string {
...
export function contractStatusClass(s: string | null | undefined): string {
  const map: Record<string, string> = {
...
// ─── Appointment badges ──────────────────────────────────────────────────────
export function aptTypeClass(t: string | null | undefined): string {
  return t === 'TEST_DRIVE' ? 'badge-blue' : 'badge-orange';
}

export function aptTypeLabel(t: string | null | undefined): string {
  return t === 'TEST_DRIVE' ? 'Test Drive' : 'Negociação';
}

export function aptStatusClass(s: string | null | undefined): string {
  const map: Record<string, string> = {
    PENDING: 'badge-yellow', COMPLETED: 'badge-green', CANCELLED: 'badge-red',
  };
  return map[s ?? ''] ?? 'badge-blue';
}

export function aptStatusLabel(s: string | null | undefined): string {
  const map: Record<string, string> = {
...
export function vehicleStatusClass(s: string | null | undefined): string {
  const map: Record<string, string> = {
    NEW: 'badge-blue', USED: 'badge-yellow', SEMINOVO: 'badge-purple',
  };
  return map[s ?? ''] ?? 'badge-blue';
}
...
export function vehicleStatusLabel(s: string | null | undefined): string {
  const map: Record<string, string> = {
    NEW: 'Novo', USED: 'Usado', SEMINOVO: 'Seminovo',
  };
  return map[s ?? ''] ?? (s ?? '—');
}
